package com.ok.mathlightalarm.service;
...
public class AlarmManagerHelper extends BroadcastReceiver {
	...
	public static final String MATH ="alarmMath";
	public static final String FLASH ="alarmFlash";
	@Override
	...
	private static PendingIntent createPendingIntent(Context context, AlarmModel model) {
	    ...
	    intent.putExtra(MATH, model.isMathEnabled);
	    intent.putExtra(FLASH, model.isFlashEnabled);
